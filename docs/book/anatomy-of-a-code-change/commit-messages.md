...
Within the subject line we disregard implementation strategies, since our fellow developers read code regularly and a glance at the commit diff conveys that information. Commit messages default to commence with the verbs "add", "remove", "update", or "refactor". We can improve our messages by starting the subject line with a representative verb, anchoring future readers to receive information in the intended context.
